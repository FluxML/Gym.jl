...
include("vis/cartpole1.jl")

function CartPoleEnv1()
    gravity = 98f-1
    masscart = 1f0
    masspole = 1f-1
...
function step!(env::CartPoleEnv1, action)
...
function reset!(env::CartPoleEnv1)
...
show(io::IO, env::CartPoleEnv1) = print(io, "CartPoleEnv1")
